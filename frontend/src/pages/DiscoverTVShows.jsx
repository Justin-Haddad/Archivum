...
function DiscoverTVShows() {
  ...
  const genres = [
    'Drama', 'Comedy', 'Action', 'Thriller', 'Sci-Fi', 'Horror', 'Romance', 'Crime'
  ]
  ...
  useEffect(() => {
    const fetchTVShows = async () => {
      ...
      try {
        ...
        setNewReleases(airingToday)
        setPopularShows(popular)
        
        // Set featured show (first trending)
        if (trending.length > 0) {
          const featuredId = trending[0].media_id
          try {
            const details = await getTVShowDetails(featuredId)
            setFeaturedShow(details)
          } catch (error) {
  ...
  const newsArticles = [
    {
      title: 'Emmy Awards Nominations Revealed',
      excerpt: 'This year\'s Emmy nominations feature several breakout shows and surprise snubs in major categories.',
      source: 'Variety',
      date: '1 day ago',
    },
    {
      title: 'New TV Shows Premiering This Month',
      excerpt: 'A guide to all the exciting new series and returning favorites hitting screens this month.',
      source: 'TV Guide',
      date: '3 days ago',
    },
    {
      title: 'Streaming Platform Updates',
      excerpt: 'Latest news on new shows, cancellations, and renewals across all major streaming services.',
    ...
    <div className="page-container">
      ...
      <div className="discover-page-header">
        <div className="discover-page-header-left">
          ...
          <h1 className="discover-page-title">TV Shows</h1>
        </div>
      ...
      <div className="discover-content-wrapper">
        ...
        <div className="discover-section-modern">
          <div className="discover-section-header-modern">
            <h2 className="discover-section-title-modern">Airing Today</h2>
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ textAlign: 'center', marginBottom: 'var(--space-xl)' }}>
              ...
              <div style={{ marginBottom: 'var(--space-xl)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 'var(--space-sm)' }}>
                ...
                />
                <label htmlFor="want-to-watch-tv" style={{ cursor: 'pointer', fontSize: '1rem', color: 'var(--color-gray-dark)' }}>
                  Add to Backlog
                </label>
              </div>
            </div>
