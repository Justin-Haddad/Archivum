...
function DiscoverBooks() {
  ...
  const genres = [
    'Fiction', 'Non-Fiction', 'Mystery', 'Romance', 'Sci-Fi', 'Fantasy', 'Biography', 'History'
  ]
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      try {
        ...
        // Set featured book (first trending)
        if (trending.length > 0) {
          const featuredId = trending[0].media_id
          try {
            const details = await getBookDetails(featuredId)
            setFeaturedBook(details)
          } catch (error) {
  ...
  const newsArticles = [
    {
      title: 'Booker Prize Shortlist Announced',
      excerpt: 'The prestigious literary award has revealed its shortlist, featuring six exceptional works of fiction.',
      source: 'The Guardian',
      date: '2 days ago',
    },
    {
      title: 'Bestseller List Updates',
      excerpt: 'This week\'s New York Times bestseller list features several debut authors and returning favorites.',
      source: 'NYT Books',
      date: '4 days ago',
    },
    {
      title: 'Book-to-Screen Adaptations Coming Soon',
      excerpt: 'A look at the most anticipated book adaptations hitting screens this year, from novels to graphic novels.',
      source: 'Literary Hub',
      date: '6 days ago',
    },
  ]
    ...
    <div className="page-container">
      ...
      <div className="discover-page-header">
        <div className="discover-page-header-left">
          ...
          <h1 className="discover-page-title">Books</h1>
        </div>
      ...
      <div className="discover-content-wrapper">
        ...
        <div className="discover-section-modern">
          ...
          {loading ? (
            ...
            <div className="discover-horizontal-scroll">
              {trendingBooks.slice(0, 10).map(item => (
                <MediaCard
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ textAlign: 'center', marginBottom: 'var(--space-xl)' }}>
              ...
              <div style={{ marginBottom: 'var(--space-xl)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 'var(--space-sm)' }}>
                <input
                  type="checkbox"
                  id="want-to-watch-books"
                  checked={selectedWantToWatch}
                  onChange={(e) => setSelectedWantToWatch(e.target.checked)}
                  style={{ width: '18px', height: '18px', cursor: 'pointer' }}
                />
                <label htmlFor="want-to-watch-books" style={{ cursor: 'pointer', fontSize: '1rem', color: 'var(--color-gray-dark)' }}>
                  Add to Backlog
                </label>
              </div>
            </div>
